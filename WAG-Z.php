			    ...
			    <div class="row">
					<div class="col-sm-12">
					   ...
					   <div class="col-sm-11">
					     <div class="col-sm-3 product-details">
							 <h4 class="product-des">DogXtar Custom Military Dog Tags - Personalized ID</h4>
							 <img src="images/product/wag/product5.png">
							 <h4 class="product-price">$10.00</h4>
						 </div>
						   <div class="col-sm-3 product-details">
							   <h4 class="product-des">Custom Embossed Dog Tag Necklaces</h4>
							   <img src="images/product/wag/product6.png">
							   <h4 class="product-price">$10.00</h4>
						 </div>
						   <div class="col-sm-3 product-details">
							   <h4 class="product-des">Custom Embossed Luggage Tags</h4>
							   <img src="images/product/wag/product7.png">
							   <h4 class="product-price">$8.00</h4>
						 </div>
						   <div class="col-sm-3 product-details">
							   <h4 class="product-des">Custom Embossed Replacement Dog Tags</h4>
							   <img src="images/product/wag/product8.png">
			    ...
			    <div class="row">
					<div class="col-sm-12">
					   ...
					   <div class="col-sm-11">
					     <div class="col-sm-3 product-details">
							 <h4 class="product-des">DogXtar Custom Military Dog Tags - Personalized ID</h4>
							 <img src="images/product/wag/product9.png">
							 <h4 class="product-price">$11.00</h4>
						 </div>
						   <div class="col-sm-3 product-details">
							   <h4 class="product-des">Custom Embossed Dog Tag Necklaces</h4>
							   <img src="images/product/wag/product10.png">
							   <h4 class="product-price">$8.00</h4>
						 </div>
						   <div class="col-sm-3 product-details">
							   <h4 class="product-des">Custom Embossed Luggage Tags</h4>
							   <img src="images/product/wag/product11.png">
							   <h4 class="product-price">$12.00</h4>
						 </div>
						   <div class="col-sm-3 product-details">
							   <h4 class="product-des">Custom Embossed Replacement Dog Tags</h4>
							   <img src="images/product/wag/product12.png">
